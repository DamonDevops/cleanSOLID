...
namespace HR_LeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20240711122806_AllocationDomainModified")]
    partial class AllocationDomainModified
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR_LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 7, 11, 14, 28, 6, 147, DateTimeKind.Local).AddTicks(4729),
                            DateModified = new DateTime(2024, 7, 11, 14, 28, 6, 147, DateTimeKind.Local).AddTicks(4790),
                            DefaultDays = 10,
                            Name = "Vacations"
                        });
                });
